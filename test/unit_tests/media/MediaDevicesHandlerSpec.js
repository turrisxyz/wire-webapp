...
describe('MediaDevicesHandler', () => {
  ...
  const fakeWorldTestSetup = {
    cameras: [
      {deviceId: 'camera1', groupId: '1', kind: MediaDeviceType.VIDEO_INPUT, label: 'Camera 1'},
      {deviceId: 'camera2', groupId: '2', kind: MediaDeviceType.VIDEO_INPUT, label: 'Camera 2'},
    ],
    microphones: [
      {deviceId: 'mic1', groupId: '1', kind: MediaDeviceType.AUDIO_INPUT, label: 'Mic 1'},
      {deviceId: 'mic2', groupId: '2', kind: MediaDeviceType.AUDIO_INPUT, label: 'Mic 2'},
    ],
    speakers: [
      {deviceId: 'speaker1', groupId: '1', kind: MediaDeviceType.AUDIO_OUTPUT, label: 'Speaker 1'},
      {deviceId: 'speaker2', groupId: '2', kind: MediaDeviceType.AUDIO_OUTPUT, label: 'Speaker 2'},
    ],
  };

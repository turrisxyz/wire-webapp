...
const RANDOM_WORDS_2 = [
  ...['alligator', 'alpaca', 'ant', 'antelope', 'asp', 'badger', 'bat'],
  ...['bear', 'bee', 'beetle', 'bird', 'bison', 'bobcat', 'buffalo'],
  ...['buzzard', 'camel', 'caribou', 'carp', 'cat', 'catfish', 'cheetah'],
  ...['clam', 'cobra', 'cod', 'condor', 'cow', 'coyote', 'crane', 'crayfish'],
  ...['cricket', 'crow', 'deer', 'dog', 'dolphin', 'donkey', 'dove', 'duck'],
  ...['eagle', 'eel', 'elk', 'falcon', 'ferret', 'finch', 'fly', 'fox'],
  ...['frog', 'gazelle', 'giraffe', 'gnu', 'goat', 'goose', 'gopher'],
  ...['grouse', 'gull', 'halibut', 'hamster', 'hare', 'hawk', 'heron'],
  ...['herring', 'horse', 'husky', 'impala', 'jackal', 'jaguar', 'kangaroo'],
  ...['koala', 'lemur', 'lion', 'lizard', 'llama', 'lobster', 'mackerel'],
  ...['mole', 'moose', 'moth', 'mouse', 'mule', 'mussel', 'newt', 'octopus'],
  ...['orca', 'ostrich', 'otter', 'owl', 'ox', 'oyster', 'panda', 'panther'],
  ...['parrot', 'pelican', 'penguin', 'pigeon', 'pike', 'pony', 'quail'],
  ...['rabbit', 'racoon', 'ram', 'raven', 'salmon', 'sardine', 'seal'],
  ...['shark', 'sheep', 'sloth', 'snail', 'snake', 'squid', 'sturgeon'],
  ...['swan', 'tiger', 'tilapia', 'toad', 'trout', 'tuna', 'turkey'],
  ...['turtle', 'walrus', 'wapiti', 'wasp', 'weasel', 'whale', 'wolf'],
  ...['wombat', 'yak', 'zebra'],
];
